...
alias ark="$HOME/core-covid/packages/core/bin/run"
echo 'alias covid="$HOME/core-covid/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-covid"
git clone "https://github.com/covid19-labs/core" "$HOME/core-covid" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/covid19-labs/core'"
...
rm -rf "$HOME/.config/@covid"
rm -rf "$HOME/.config/@covid"
rm -rf "$HOME/.config/covid-core"
